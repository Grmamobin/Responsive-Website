...
import Positivus from '../../assets/images/Positivus (2).svg'
import icon1 from '../../assets/images/Social icon (1).svg'
import icon2 from '../../assets/images/Social icon (2).svg'
import icon3 from '../../assets/images/Social icon (3).svg'
import heading from '../../assets/images/Heading (4).svg'
...
export default function Footer(){
    ...
    <div className='lg:flex inline-flex lg:pt-[55px] lg:px-[60px] lg:pb-[50px] pt-[50px] px-[20px] pb-[30px] flex-col items-center lg:gap-[50px] gap-[37px] border lg:rounded-t-[45px] bg-[var(--Dark,#191A23)] text-white w-full lg:flex-col'>
        <div className='flex flex-col lg:gap-[66px] gap-[37px] flex-wrap '>
            <div className='flex w-full items-center lg:justify-between lg:flex-row flex-col gap-[37px]'>
                <div className='flex gap-[10.29px]'>
                    <img className='w-[29.517px] h-[29px] flex-shrink' src={icon} alt=""/>
                    <img  className='w-[139.89px] h-[23.007px] flex-shrink' src={Positivus} alt="" />
                </div>
            ...
            <div className='flex lg:items-start items-center gap-[37px] lg:justify-between lg:flex-row flex-col'>
