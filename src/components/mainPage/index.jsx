...
import positive from '../../assets/images/Positivus.svg';
import burgerMenu from '../../assets/images/Burger menu icon.svg';
import mainImg from '../../assets/images/Screenshot 2024-07-09 at 12.01.47.png';
import amazon from '../../assets/images/amazon.svg';
import dribble from '../../assets/images/dri.svg';
...
export default function MainPage(){
    ...
    <header className='justify-between items-center lg:flex lg:flex-row pb-[70px] flex lg:px-[20px]'>
        <div className='header-left flex justify-center items-center lg:gap-[12.92px] gap-[8.475px] w-[144px] h-[23.613px]'>
            <img className='lg:w-[36px] lg:h-[36px] w-[23.613px] h-[23.613px]' src={icon} alt="icon" />
            <img className='lg:w-[170.617px] lg:h-[28.56px] w-[111.912px] h-[18.733px]' src={positive} alt="positive" />
        </div>
    ...
    flex-col">
        <div className="middle-left">
            ...
            <div className="middle-right flex lg:hidden">
                <img className='mainImg lg:w-85 lg:h-85 gap-[10px] w-full'  src={mainImg} alt="" />
            </div>
