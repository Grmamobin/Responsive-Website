...
export default function Services(){
    ...
    <div className='flex flex-col gap-[40px]'>
        <div className='flex items-first pr-[100px] gap-[40px]'>
    ...
    <div className='flex w-[1240px] h-[347px] pr-[60px] pl-[60px] items-center gap-[275px] border rounded-[45px] bg-[var(--Grey,#F3F3F3)] mt-[85px]'>
