...
export default function Team(){
    return(
    <>
    <div className='flex flex-wrap justify-start items-center w-full pb-[85px] text-lg gap-[45px] sm:flex-row'>
    ...
    <div className='flex flex-col sm:flex-row gap-[40px]'>
        <TeamCard name='John Smith' job='CEO and Founder' info='10+ years of experience in digital marketing. Expertise in SEO, PPC, and content strategy' pic='src/assets/images/file.png'></TeamCard>
    ...
    <div className='flex flex-col sm:flex-row pt-[40px] gap-[40px]'>
    ...
    <Button title='See all team' bgColor='var(--Dark,#191A23)' text='white' width='269px' justify='justify-center'></Button>
    </div>
    </>
)
}